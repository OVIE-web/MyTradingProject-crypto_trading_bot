...
def test_load_and_preprocess_data_generic_exception(tmp_path: Path) -> None:
    ...
    with patch("app.services.data_loader.pd.read_csv", side_effect=Exception("mocked error")):
