"""
Tests for app.services.model_registry.
...
from app.services.model_registry import ModelRegistry, create_registry
...
class TestModelRegistry:
    ...
    def test_init_default_dsn(
        ...
        monkeypatch.setattr("app.services.model_registry.DATABASE_URL", "postgresql://default")
        mock_conn = MagicMock()
        mock_connect.return_value = mock_conn
    ...
    def test_register_model(self, mock_connect: MagicMock) -> None:
        ...
        # Verify INSERT SQL execution after the init-time table check.
    ...
    def test_delete_model_success(self, mock_connect: MagicMock) -> None:
        ...
        # Verify DELETE SQL execution after the init-time table check.
        assert mock_cursor.execute.call_count == 2
        execute_args = mock_cursor.execute.call_args[0]
...
class TestCreateRegistry:
    ...
    @patch("app.services.model_registry.ModelRegistry")
