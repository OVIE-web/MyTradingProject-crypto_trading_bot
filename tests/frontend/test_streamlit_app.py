...
class TestValidateTechnicalIndicators:
    ...
    def test_validate_all_valid_inputs(self, sample_user_input: dict[str, float]) -> None:
        ...
        from app.frontend.streamlit_app import validate_technical_indicators
...
class TestDatabaseManager:
    ...
    @patch("app.frontend.streamlit_app.SessionLocal")
    def test_get_session_success(self, mock_session_local) -> None:
        """Test successful database session creation."""
        from app.frontend.streamlit_app import DatabaseManager
...
class TestTelegramMessaging:
    ...
    async def test_send_telegram_async_success(self, mock_telegram_notifier) -> None:
        ...
        from app.frontend.streamlit_app import send_telegram_async
    ...
    def test_send_telegram_message_empty(self, mock_telegram_notifier) -> None:
        ...
        from app.frontend.streamlit_app import send_telegram_message
...
class TestModelLoading:
    ...
    @patch("app.frontend.streamlit_app.load_trained_model")
    def test_model_load_success(self, mock_load_model) -> None:
        """Test successful model loading."""
        mock_model = Mock()
        mock_load_model.return_value = mock_model

        from app.frontend.streamlit_app import load_trained_model
...
class TestPredictions:
    ...
    def test_make_predictions_success(self, mock_model) -> None:
        ...
        from app.frontend.streamlit_app import make_predictions
...
class TestDependencyManagement:
    ...
    def test_dependencies_dict_exists(self) -> None:
        ...
        from app.frontend.streamlit_app import DEPENDENCIES
    ...
    def test_feature_columns_fallback(self) -> None:
        ...
        from app.frontend.streamlit_app import FEATURE_COLUMNS
    ...
    def test_trade_symbol_fallback(self) -> None:
        ...
        from app.frontend.streamlit_app import TRADE_SYMBOL
...
class TestLogging:
    ...
    def test_logger_configured(self) -> None:
        ...
        from app.frontend.streamlit_app import logger

        assert logger is not None
        assert logger.name == "app.frontend.streamlit_app"

    def test_logging_on_signal_generation(self, sample_user_input) -> None:
        """Test that signal generation is logged."""
        from app.frontend.streamlit_app import validate_technical_indicators

        with patch("app.frontend.streamlit_app.logger") as mock_logger:
...
class TestIntegration:
    ...
    def test_complete_signal_generation_flow(
        ...
        from app.frontend.streamlit_app import make_predictions, validate_technical_indicators
