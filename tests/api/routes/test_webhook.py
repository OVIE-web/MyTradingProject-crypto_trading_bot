# tests/api/routes/test_webhook.py
...
from app.api.routes.webhook import router, verify_signature
...
class TestVerifySignature:
    def test_valid_signature_returns_true(self):
        ...
        with patch("app.api.routes.webhook.WEBHOOK_SECRET", MOCK_SECRET):
    ...
    def test_empty_secret_returns_false(self):
        payload = make_payload({"ref": "refs/heads/main"})
        signature = make_signature(payload)
        with patch("app.api.routes.webhook.WEBHOOK_SECRET", ""):
