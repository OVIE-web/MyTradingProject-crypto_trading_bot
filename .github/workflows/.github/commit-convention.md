...
| **ci:** | CI/CD workflow, Docker, or deployment configuration updates |
...
| **ci** | GitHub Actions, Docker, or pipeline automation |
...
ci: add linting and pytest jobs to GitHub Actions
...
✅ Tests pass locally and in CI (pytest -v)
